...
class Habilidades extends Component {
    ...
    getHabilidades = () => {
        axios.get(`http://localhost:5000/api/getHabilidades`)
		.then(res => {
    ...
    createUpdateHabilidade = () => {
        axios.post(`http://localhost:5000/api/createUpdateHabilidade`, {
            id: this.state.inId,
    ...
    handleRemove = (rowId) => {
        axios.post(`http://localhost:5000/api/deleteHabilidade`, {
...
export default withStyles(styles)(Habilidades);