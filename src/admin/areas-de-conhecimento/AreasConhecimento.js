...
class AreasConhecimento extends Component {
    constructor(props) {
        super(props);
    ...
    createUpdateAreaConhecimento = () => {
        axios.post(`http://localhost:5000/api/createUpdateAreaConhecimento`, {
            id: this.state.inId,
    ...
    handleOk = () => {
        ...
        this.createUpdateAreaConhecimento();
    }
    ...
    handleRemove = (rowId) => {
        axios.post(`http://localhost:5000/api/deleteAreaConhecimento`, {
...
AreasConhecimento.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AreasConhecimento);